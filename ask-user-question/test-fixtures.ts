...
import type {
	PreviewPane,
	PreviewPaneProps,
} from "./view/components/preview/preview-pane.js";
...
export function makeQuestionnaireState(
	over: Partial<QuestionnaireState> = {},
): QuestionnaireState {
	return {
...
export function makeApplyContext(
	over: Partial<ApplyContext> = {},
): ApplyContext {
...
export function makeTabComponents(
	over: Partial<TabComponents> = {},
): TabComponents {
	return {
